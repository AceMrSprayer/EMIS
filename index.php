    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            ...
            if(isset($_SESSION['success'])){
                echo '<label for="message"><div class="alert alert-success message-content"><b id="message">'.$_SESSION['success'].'</b></div></label>';
                echo '<a class="navbar-brand" id="message" href="index.php">EMIS Dashboard</a>';
               unset($_SESSION['success']);
            }else{
                echo ' <a class="navbar-brand" href="index.php">EMIS Dashboard</a>';
            }
            ?>
            <!-- /.navbar-header -->
